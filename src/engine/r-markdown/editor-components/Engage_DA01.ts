...
export const Engage_DA01 = {
  ...
  render(attrs: Record<string, string>, _body: string, t: ThemeColors): string {
    ...
    html += `<span style="display:inline-block;margin:0px 10px;width:32px;height:32px;vertical-align:middle"><svg viewBox="0 0 24 24" width="32" height="32" style="display:block" xmlns="http://www.w3.org/2000/svg"><path d="M21 12l-7-7v4C7 10 4 15 3 20c2.5-3.5 6-5.1 11-5.1V19l7-7z" fill="currentColor"></path></svg></span>`
    ...
    html += `</section>`
    html += `<p style="margin:0px 0px 4px;font-size:10px;color:${t.accent};font-weight:800;letter-spacing:2px;text-transform:uppercase">${leaf('点赞 · 转发 · 推荐')}</p>`
