...
#nice h2 .prefix {
  ...
  height: 20px;
  background-size: 20px 20px;
  background-image:url(/themes/fullStackBlue-h1.png);
  margin-bottom: -22px;
}
...
#nice h3 .content:before{
  ...
  height:30px;
  display:block;
  background-image:url(/themes/fullStackBlue-h2.png);
  position:absolute;
...
#nice h4 .content:before{
  content:'';
  background-image:url(/themes/fullStackBlue-h3.png);
  display:inline-block;
  width:16px;
  height:16px;
...
#nice figcaption:before{
  content:'';
	background-image:url(/themes/fullStackBlue-blockquote.png);
  display:inline-block;
  width:18px;
  height:18px;
