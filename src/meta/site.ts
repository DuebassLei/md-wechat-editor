...
export const WECHAT_MP_PROMO = {
  ...
  accountName: (import.meta.env.VITE_WECHAT_MP_NAME as string | undefined)?.trim() || '墨韵简排',
  hint: (import.meta.env.VITE_WECHAT_MP_HINT as string | undefined)?.trim() || '排版技巧 · 更新通知',
